...
import sys
sys.path.append('/t3home/gcelotto/CMSSW_10_2_15/src/PhysicsTools/BParkingNano/test/')
from getBackgroundList import *
...
outputFileNANO = cms.untracked.string('_'.join(['QCDMuEnriched_BParkNANO', extension[options.isMC], options.tag])+'.root')
outputFileFEVT = cms.untracked.string('_'.join(['BParkFullEvt', extension[options.isMC], options.tag])+'.root')
if not options.inputFiles:
    options.inputFiles = [
        '/store/mc/RunIIAutumn18MiniAOD/GluGluHToBB_M125_13TeV_powheg_pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/90000/CFBFCA29-1649-2345-970E-731824064446.root'] if not options.isMC else getQCDMuEnriched(3)
